...
// 
//		other files included: BST.h, studentList.cpp, node.h, studentFile.txt
//		 	
//****************************************************************************************************
...
{
	out << left << setw(9) << data.id << left << setw(27) << data.name
		<< left << setw(9) << fixed << setprecision(2) << data.gpa << data.major << endl;
